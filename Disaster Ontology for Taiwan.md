...
| :--- | :--- | :--- | :--- | :--- | :--- |
| **台灣 (災害防救法)** [1, 2] | 時間序列 / 階段式 | 預防、應變、復原 | 符合本地法規，為利害關係人所熟悉。 | 結構可能過於僵化，未能有效描述功能性關聯。 | 提供本體論的頂層結構。 |
| **日本 (防災基本計画)** [5, 6] | 時間序列 / 階段式 | 預防、緊急應變、復原重建 | 與台灣模式相似，易於比較最佳實踐。 | 與台灣模式相同。 | 強化了階段式方法的有效性。 |
| **美國 (NRF)** [16, 25, 26] | 功能性 / 能力導向 | 緊急支援功能 (ESFs)、社群生命線、分層應變 | 非常適合組織複雜的多領域應變行動，並評估系統性衝擊。 | 在時間順序上可能不夠直觀；ESF結構高度美國中心化。 | 採用「社群生命線」概念來組織「應變」與「復原」階段的內部資料結構。 |
